                                    ...
                                    <tr>
                                        <td>
                                            <div class="table-image">
                                                <img src="{{ asset($product->image_1)}}" class="img-fluid product_image"
                                                    alt="">
                                            </div>
                                        </td>
                                        ...
                                        <td class="status-danger status-block">
                                            ...
                                            <img style="display: none;" style="height:7rem;width:7rem;"
                                                src="{{asset('adminassets/images/loader/verification.gif')}}" alt="">
                                        </td>
                                            ...
                                            <ul>
                                                <li>
                                                    <a title="edit product"
                                                        href="{{ url('admin/product/edit', ['id' => $product->id]) }}">
                                                ...
                                                <li>
                                                    <form method="post"
                                                        ...
                                                        @csrf
                                                        <button style="color:red;border:0px solid white;font-size:17px;"
                                                ...
                                                <li>
                                                    @if($product->status == 1)
                                                    <button class="product-verification"
                                                        data-product-id="{{$product->id}}"
                                                        data-product-status="{{$product->status}}"
                                                        style="border:0px solid white;background-color:transparent;">
                                                        <img alt="" style="height:2rem;width:2rem;"
                                                            src="{{asset('adminassets/images/loader/unverified.svg')}}"
                                                    ...
                                                    <button class="product-verification"
                                                        ...
                                                        style="border:0px solid white;background-color:transparent;">
                                                        <img alt="" style="height:2rem;width:2rem;"
                                                            src="{{asset('adminassets/images/loader/verified.svg')}}"
