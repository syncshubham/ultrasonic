...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="row">
                <form action="{{ route('create.product') }}" method="post" class="col-sm-8 m-auto"
                        ...
                        <div class="card-body">
                            ...
                            <div class="theme-form theme-form-2 mega-form">
                                ...
                                <div class="mb-4 row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="unit" class="js-example-basic-single w-100">
                                            ...
                                            <option {{ old('unit')=='kg' ? 'selected' : '' }} value="kg">Kilogram
                                            </option>
                                            <option {{ old('unit')=='pcs' ? 'selected' : '' }} value="pcs">Pieces
                                            </option>
                                        </select>
                                        @if ($errors->has('unit'))
                                    ...
                                    <div class="col-sm-9">
                                        <label class="switch">
                                            <input type="checkbox" name="exchangeable" value="1" {{
                                                old('exchangeable')=='1' ? 'checked' : '' }}><span
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <label class="switch">
                                            <input type="checkbox" name="refundable" value="1" {{ old('refundable')=='1'
                                    ...
                                    <div class="row col-sm-9">
                                        ...
                                        <div class="col-12 col-md-7 checkbox-center paddingcheckbox">
                                            <div class="checkboxitemsalignment">L<input type="checkbox" name="sizes[]"
                                                    value="l" class="" id="" {{ in_array('l', old('sizes', []))
                                                    ? 'checked' : '' }}></div>
                                            <div class="checkboxitemsalignment">XL<input type="checkbox" name="sizes[]"
                                                    value="xl" class="" id="" {{ in_array('xl', old('sizes', []))
                                                    ? 'checked' : '' }}></div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="form-control" name="more_details" id=""
                                                    rows="8">{{old('more_details')}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" name="bulletin_1"
                                                    value="{{old('bulletin_1')}}" type="text">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" name="bulletin_2"
                                                    value="{{old('bulletin_2')}}" type="text">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" name="bulletin_3"
                                                    value="{{old('bulletin_3')}}" type="text">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" name="bulletin_4"
                                                    value="{{old('bulletin_4')}}" type="text">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" name="bulletin_5"
                                                    value="{{old('bulletin_5')}}" type="text">
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="theme-form theme-form-2 mega-form">
                                <div class="mb-4 row align-items-center">
                                    <label class="col-sm-3 col-form-label form-label-title"><span
                                        ...
                                        1</label>
                                    <div class="col-sm-9">
                                        <input onchange="fileValidation(this)" class="form-control form-choose"
                            ...
                            <div class="theme-form theme-form-2 mega-form">
                                <div class="mb-4 row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input onchange="fileValidation(this)" class="form-control form-choose"
                                            name="image_2" type="file" id="formFile">
                            ...
                            <div class="theme-form theme-form-2 mega-form">
                                <div class="mb-4 row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input onchange="fileValidation(this)" class="form-control form-choose"
                                            name="image_3" type="file" id="formFile">
                            ...
                            <div class="theme-form theme-form-2 mega-form">
                                <div class="mb-4 row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input onchange="fileValidation(this)" class="form-control form-choose"
                                            name="image_4" type="file" id="formFile">
                            ...
                            <div class="theme-form theme-form-2 mega-form">
                                <div class="mb-4 row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input onchange="fileValidation(this)" class="form-control form-choose"
                                            name="image_5" type="file" id="formFile">
                                ...
                                <div class="mb-4 row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" id="originalPrice" name="price"
                                            value="{{old('price')}}" type="number" placeholder="0">
                                        @if ($errors->has('price'))
                                ...
                                <div class="mb-4 row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" id="discountPercentage" name="disc_rate"
                                            value="{{old('disc_rate')}}" type="number" placeholder="0">
                                    </div>
                                </div>
                                <div class="mb-4 row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" id="discountAmount" name="disc_price"
                                            value="{{old('disc_price')}}" type="number" placeholder="0" readonly>
                                    </div>
                                </div>
                                <div class="mb-4 row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input style="font-weight:bold;color:darkblue;" class="form-control"
                                            name="final_price" value="{{old('final_price')}}" type="number"
                                            id="finalPrice" placeholder="0" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="mb-4 row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" name="description" value="{{old('description')}}"
                                            type="text" placeholder="Enter page description here">
                                ...
                                <div class="mb-4 row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <input class="form-control" name="keywords" value="{{old('keywords')}}"
                                            type="text" placeholder="Enter page keywords title here">
...
<script>
    ...
    function fileValidation(fileInput) {
        ...
        if (!allowedExtensions.exec(filePath)) {
            ...
            if (fileSize > maxSize) {
                customAlert.alert('File size exceeds' + '<br>' + 'Max allowed size (350 KB)', 'Alert !!!');
                fileInput.value = '';
                return false;
            }
        }
