...
<link rel="canonical"
    href="https://ultra-sonicltd.com/product/{{$product->id}}/{{strtolower(str_replace(' ', '-', $product->product_name))}}">
<meta content="en_US" property="og:locale">
<meta content="Ultrasonic Ltd." property="og:site_name">
<meta content="website" property="og:type">
<meta
    content="https://ultra-sonicltd.com/product/{{$product->id}}/{{strtolower(str_replace(' ', '-', $product->product_name))}}"
    property="og:url">
<meta content="{{$product->meta_title}}" property="og:title">
<meta content="{{$product->meta_description}}" property="og:description">
        ...
        <section class="py-3 border-bottom d-none d-md-flex">
            <div class="container">
                <div class="page-breadcrumb d-flex align-items-center">
                    <h1 class="breadcrumb-title pe-3">{{$product->product_name}}</h1>
                    <div class="ms-auto">
                                    ...
                                    <div class="product-gallery owl-carousel owl-theme border mb-3 p-3"
                                        ...
                                        @for($i = 1; $i <= 5; $i++) @php $imageVariable="image_" . $i;
                                            ...
                                            <div class="item quickviewimagesection">
                                                <img src="{{ asset($imageUrl) }}" class="img-fluid quickviewimages"
                                                    alt="{{$imagealttext}}">
                                            </div>
                                            @endif
                                            @endfor
                                    ...
                                    <div class="owl-thumbs d-flex justify-content-center" data-slider-id="1">
                                        @for($i = 1; $i <= 5; $i++) @php $imageVariable="image_" . $i;
                                            ...
                                            <button class="owl-thumb-item">
                                                <img src="{{ asset($imageUrl) }}" class="quickviewbuttonimages"
                                                    alt="{{$imagealttext}}">
                                            </button>
                                            @endif
                                            @endfor
                            ...
                            <div class="col-12 col-lg-7">
                                <div class="product-info-section p-3">
                                    <div style="display:flex;gap:10px;align-items: center;">
                                        <h2 class="mt-3 mt-lg-0 mb-0">{{$product->product_name}}</h2>
                                        <a href="javascript:;">
                                    ...
                                    <div class="d-flex align-items-center mt-3 gap-2">
                                        ...
                                        <h5 class="mb-0 text-decoration-line-through text-light-3">¥{{$product->price}}
                                        </h5>
                                        @endif
                                    ...
                                    @if ($product->disc_rate <= 20) <p>(Save @ {{$product->disc_rate}}%)</p>
                                        ...
                                        <div class="d-flex gap-2 mt-3">
                                            <a data-product-id="{{$product->id}}" href="javascript:;"
                                                class="btn btn-white btn-ecomm confetti-button add-to-cart-button"
                                                id=""> <i class="bx bxs-cart-add"></i>Add to Cart
                ...
                <div class="product-more-info">
                    ...
                    <div class="tab-content pt-3">
                        ...
                        <div class="tab-pane fade" id="more-info" role="tabpanel">
                            <ul>
                                @if ($product->bulletin_1 || $product->bulletin_2 || $product->bulletin_3 ||
                                $product->bulletin_4 || $product->bulletin_5)
                                <ul>
