...
@section('meta')
<title>Your Shopping Cart | Ultrasonic Ltd. Hearing Aids</title>
<meta name="description"
    content="View your shopping cart at Ultrasonic Ltd. Review your selected hearing aids and accessories, and proceed to checkout for a seamless shopping experience.">
<meta name="keywords"
    content="shopping cart Ultrasonic Ltd, hearing aids cart, Bluetooth hearing aids, review cart items, checkout hearing aids, online shopping cart">
<link rel="canonical" href="https://ultra-sonicltd.com/product/cart">
<meta content="en_US" property="og:locale">
<meta content="Ultrasonic Ltd." property="og:site_name">
<meta content="website" property="og:type">
<meta content="https://ultra-sonicltd.com/product/cart" property="og:url">
<meta content="Your Shopping Cart | Ultrasonic Ltd. Hearing Aids" property="og:title">
<meta
    content="View your shopping cart at Ultrasonic Ltd. Review your selected hearing aids and accessories, and proceed to checkout for a seamless shopping experience."
...
<meta name="twitter:title" content="Your Shopping Cart | Ultrasonic Ltd. Hearing Aids">
<meta name="twitter:description"
    content="View your shopping cart at Ultrasonic Ltd. Review your selected hearing aids and accessories, and proceed to checkout for a seamless shopping experience.">

<meta property="og:title" content="Your Shopping Cart | Ultrasonic Ltd. Hearing Aids" />
<meta property="og:description"
    content="View your shopping cart at Ultrasonic Ltd. Review your selected hearing aids and accessories, and proceed to checkout for a seamless shopping experience." />
<meta property="og:url" content="https://ultra-sonicltd.com/product/cart" />
        ...
        <section class="py-3 border-bottom d-none d-md-flex">
            <div class="container">
                <div class="page-breadcrumb d-flex align-items-center">
                    <h1 class="breadcrumb-title pe-3">Shop Cart</h1>
                    <div class="ms-auto">
                    ...
                    <div class="row">
                        <div class="col-12 col-xl-8">
                            <div class="shop-cart-list mb-3 p-3">
                                ...
                                <div data-cart-item-id="{{$cartItem->cart_id ? $cartItem->cart_id : $cartItem->product->id}}"
                                    ...
                                    <div class="col-12 col-lg-9">
                                        ...
                                        <div class="d-lg-flex align-items-center gap-2">
                                            <div class="cart-img text-center text-lg-start">
                                                <img style="height:8rem;" src="{{ asset($cartItem->product->image_1) }}"
                                                    width="130" alt="">
                                            </div>
                                            <br>
                                            <div class="cart-detail text-center text-lg-start">
                                                <h6 class="mb-2">{{$cartItem->product->product_name}}</h6>
                                                <p class="mb-0">Size: <span>{{$cartItem->size}}</span>, Quantity:
                                                    <span>{{$cartItem->quantity}}</span>
                                                </p>
                                                <p class="mb-2">Description:
                                                    <span>{{$cartItem->product->short_desc}}</span>
                                                </p>
                                    ...
                                    <div class="col-12 col-lg-3">
                                        ...
                                        <div class="text-center">
                                            <div class=""> <a href="javascript:;"
                                                    class="btn btn-light rounded-0 btn-ecomm delete-cart-item"><i
                                ...
                                <div class="d-lg-flex align-items-center gap-2"><a href="/#featuredProducts"
                        ...
                        <div id="mainCheckoutPanelCartPage" class="col-12 col-xl-4">
                            <div class="checkout-form p-3 bg-dark-1">
                                <div class="card rounded-0 border bg-transparent mb-0 shadow-none">
                                    <div id="checkoutLayoutLoader" class="loader-delete-product" style="display: none;">
                                    </div>
                                    <form method="post" action="{{ route('main.checkout') }}" class="card-body">
                                        @csrf
                                        <p class="mb-2">Total Items: <span id="cartPageTotalProducts"
                                                class="float-end">{{$totalNumberOfProducts}}</span>
                                        </p>
                                        <input type="hidden" value="{{$totalNumberOfProducts}}"
                                            name="totalnumberproducts">
                                        <input type="hidden" value="{{$totalAmount}}" name="totalamount">
                                        <input type="hidden" value="20%" name="discount">

                                        <p class="mb-2">Subtotal: <span id="cartSubTotalAmount" class="float-end">¥
                                                {{$totalAmount}}</span>
                                        </p>
                                        ...
                                        <h5 class="mb-0">Order Total: <span id="cartTotalAmount" class="float-end">¥
                                                {{$totalAmount}}.00</span></h5>
                                        <div class="my-4"></div>
                                        <button style="width:100%;" type="submit" class="d-grid"> <a
                                                class="btn btn-white btn-ecomm">Proceed to Checkout</a>
                                        </button>
                                    </form>
                                </div>
                            </div>
